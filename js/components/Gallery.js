                ...
                <div class="border m-6 rounded-lg bg-white mx-auto shadow-lg max-w-xs overflow-hidden">
                    ...
                    <div class="px-4 py-3 relative min-h-3">
                        ...
                        <div class="mt-2 text-center sm:text-left sm:flex-grow">
                            ...
                            <a class="text-blue no-underline" href="https://tailwindcss.com">Tailwindcss</a> built by awesome people who want to make the web a better place.
                        </p>
                            </div>
                            <p class="mt-6 text-xs text-grey-dark">
                                Followed by
                        <a class="text-blue no-underline" href="#">Google</a> and
                        <a class="text-blue no-underline" href="5 others">5 others</a>
                            </p>
                        </div>
                    </div>
                </div>
